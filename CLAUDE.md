...
- 설계 문서: `docs/meta_design.html`(아키타입·상성·위협↔해답), `docs/element_design.html`(7속성 메인+서브2·가격 규칙), `docs/keywords.html`(속성별 크리처 키워드 14종·예산 환산·상성), `docs/spells.html`(속성별 시그니처 스펠 14종·티어 확장). 관통 채택 확정.
